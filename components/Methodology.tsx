...
const Methodology: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      desc: "Você confirma dados, organiza documentação e conduz.",
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8">
          {steps.map((step, idx) => (
            <motion.div
              ...
              className="relative w-full md:w-[200px] p-6 pt-10 md:pt-12 rounded-2xl bg-neutral-900 border border-white/5 hover:border-brand-gold/50 transition-colors flex flex-col items-center text-center"
            >
