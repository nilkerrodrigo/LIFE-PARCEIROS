        ...
        <div className="space-y-6">
          ...
          <div className="pt-6 md:pt-8 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
             ...
             <div className="flex flex-col items-center w-full md:w-auto">
                <a href={linkEmpreendedor} target="_blank" rel="noopener noreferrer" className="btn-luxury w-full md:w-auto inline-block py-3 px-6 md:py-4 md:px-8 rounded-full text-sm md:text-base font-bold min-w-[280px]">
             ...
             {/* CTA 2: Business */}
             <div className="flex flex-col items-center w-full md:w-auto">
                <a href={linkBusiness} target="_blank" rel="noopener noreferrer" className="w-full md:w-auto inline-block py-3 px-6 md:py-4 md:px-8 rounded-full text-sm md:text-base font-bold min-w-[280px] border border-white/20 hover:border-brand-gold hover:text-brand-gold transition-all bg-white/5 backdrop-blur-sm">
