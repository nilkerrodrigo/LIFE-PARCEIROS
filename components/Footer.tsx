  ...
  return (
    <footer className="bg-black border-t border-white/10 pt-20 pb-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500">
            <li><a href="#" className="hover:text-brand-red transition-colors">Painel do Cliente</a></li>
            <li><a href="#services" className="hover:text-brand-red transition-colors">Serviços</a></li>
            <li><a href="#academy" className="hover:text-brand-red transition-colors">Academy</a></li>
            <li><a href="#support" className="hover:text-brand-red transition-colors">Suporte</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500">
            ...
            <li><a href="#" className="hover:text-brand-red transition-colors">Compliance</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500">
            ...
            <li>contato@hcacademy.com.br</li>
      ...
      <div className="max-w-7xl mx-auto border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600 gap-4">
        <p>&copy; 2024 HC Academy. Todos os direitos reservados.</p>
        <p>Designed with <span className="text-brand-red">♥</span> for excellence.</p>
      </div>
    </footer>
  );
};
